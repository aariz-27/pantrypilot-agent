...
**Security note:** a pre-existing committed API key (predating this ticket) was found and remediated by untracking `backend/.env`; the Founder rotated the affected key. No key value is present in any commit, PR, or report for this ticket.
