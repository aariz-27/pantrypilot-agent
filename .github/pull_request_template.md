...
List the main files or directories changed and why.
...
- [ ] No unnecessary framework/infrastructure was added.
...
- [ ] No accidental N+1/repeated expensive calls were introduced.
...
15. Migration / Release Impact
 No migration/release impact.
 Database migration required.
 Reference data update required.
 Environment/configuration change required.
...
ChatGPT performs independent review of the actual code/diff/tests.
